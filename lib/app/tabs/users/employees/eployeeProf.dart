...
class emplProf extends StatefulWidget {
  const emplProf({Key key}) : super(key: key);

  @override
  _emplProfState createState() => _emplProfState();
}

class _emplProfState extends State<emplProf> {
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Text("ADD Employee",style: TextStyle(fontSize:20,color: Colors.black),),),
            ],
          ),
          SizedBox(height: 40,),
          Center(
