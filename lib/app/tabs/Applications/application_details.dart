...
//     thisMonthApplication=0;
//     thisYearApplication=0;
//
//     FirebaseFirestore.instance.collection('applicationForms')
//         .where('status',isEqualTo: 0).snapshots()
//         .listen((event) {
//
//       pendingApplication=event.docs.length;
//
//           if(mounted){
//             setState(() {
//
...
//         .listen((event) {
//
//       thisMonthApplication=event.docs.length;
//
//       if(mounted){
//         setState(() {
//
...
//     FirebaseFirestore.instance.collection('applicationForms')
//         .where('status',isEqualTo: 1)
//         .where('date',isGreaterThanOrEqualTo: thisYear)
//         .snapshots()
//         .listen((event) {
//
//       thisYearApplication=event.docs.length;
//
//       if(mounted){
//         setState(() {
//
...
//                                     onPressed: () {
//
//                                       Navigator.push(context, MaterialPageRoute(builder: (context)=>ApplicationDetailsView1(
...
//                                     onPressed: () {
//
//                                       Navigator.push(context, MaterialPageRoute(builder: (context)=>ApplicationDetailsView(
//                                         id: data[index]['candidateId'],
//                                         appId: data[index].id,
//                                         status: data[index]['status'],
//
