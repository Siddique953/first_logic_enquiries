...
//
// class ApplicationDetailsView1 extends StatefulWidget {
//   final String id;
//   final String appId;
//   final int status;
//   const ApplicationDetailsView1({Key key, this.id, this.appId, this.status})
//       : super(key: key);
//
//   @override
//   State<ApplicationDetailsView1> createState() =>
//       _ApplicationDetailsView1State();
// }
//
// class _ApplicationDetailsView1State extends State<ApplicationDetailsView1> {
