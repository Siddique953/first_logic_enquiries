...
class DeletedEmployees extends StatefulWidget {
  ...
  const DeletedEmployees({
    ...
    required TabController tabController,
        ...
        super(key: key);
  @override
  State<DeletedEmployees> createState() => _DeletedEmployeesState();
}

class _DeletedEmployeesState extends State<DeletedEmployees> {
...
//GET FIRST 20 DATA
  ...
  void initState() {
    ...
    listOfCustomers=employeeList.where((element) => element['delete']==true).toList();
    listOfFilteredCustomers = [];
    // getCustomers();
