...
class CustomerListingWidget extends StatefulWidget {
  ...
  @override
  State<CustomerListingWidget> createState() => _CustomerListingWidgetState();
}

class _CustomerListingWidgetState extends State<CustomerListingWidget> {
                            ...
                            return DataRow(
                              ...
                              cells: [
                                ...
                                DataCell(SelectableText(
                                  dateTimeFormat(
                                      'd-MMM-y',
                                      listOfFilteredCustomers[index]['date']
                                          .toDate()),
                                  style: FlutterFlowTheme.bodyText2.override(
                                    fontFamily: 'Lexend Deca',
                                    color: Colors.black,
